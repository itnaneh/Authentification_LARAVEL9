...
<body>
	...
	<div class="login-html">
		<div>
			<h1 style="text-align: center;color:#1161ee;margin-bottom: 60px;font-family: 'nunito';font-weight: normal;">Welcome !</h1>
		</div>
		
		<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label>
		<input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"><a href="{{ route('register') }}">Register</a></label>
